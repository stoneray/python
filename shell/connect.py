...
def print_prompt():
    msg = """          |----------------------------------------------------------------------------------------------------------|
          |		\033[1;32m                           欢迎使用壹号车运维管理平台    \033[0m                                  |
          |                                                                                                          |
          |  1) 输入\033[32m大写P/小写p \033[0m查询可以管理的远程主机                                                               |
          |  2) 输入 \033[32mIP地址或者IP地址的一部分\033[0m 登录远程主机                                                           |
          |	(例如:\033[1;31m172.0.0.10\033[0m,输入完整的IP地址或者\033[1;31m172.0,172.0.0,10\033[0m都可以快速登录)                               |
          |                                                                                                          |
          |  3) 输入 \033[32m大写E/小写e\033[0m 可以在远程主机上执行命令                                                            |
          |  4) 输入 \033[32m大写Q/小写q\033[0m 退出                                                                                |
          |	                                                                                                   |
          |                                                                                                          |
          |    \033[1;31m备注:您的全程操作将被堡垒机系统记录，请谨慎操作!!!\033[0m                                                    |
          |----------------------------------------------------------------------------------------------------------|
    """
...
def connect(username, password, host, port, login_name):
    ...
    """
    ps1 = "PS1='[\u@%s \W]\$ '\n" % host
    login_msg = "echo -e '\\033[32mLogin %s done. Enjoy it.\\033[0m'\n" % host
